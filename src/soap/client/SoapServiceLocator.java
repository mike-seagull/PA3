...
public class SoapServiceLocator extends org.apache.axis.client.Service implements soap.client.SoapService {
    ...
    private java.lang.String Soap_address = "http://localhost:8080/PA3/services/Soap";
    ...
    public soap.client.Soap getSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.client.SoapSoapBindingStub _stub = new soap.client.SoapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.client.Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.client.SoapSoapBindingStub _stub = new soap.client.SoapSoapBindingStub(new java.net.URL(Soap_address), this);
                _stub.setPortName(getSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap", "SoapService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap", "Soap"));
        }
